...
class VisiMisiController extends BaseController
{
    ...
    public function index()
    {
        ...
        return $this->sendResponse(
            new VisiMisiResource($visi->first()), 'VisiMisi retrieved successfully.');
    }
    /**
    ...
    public function show($id)
    {
        ...
        if (is_null($visi)) {
            return $this->sendError('VisiMisi not found.');
        }

        return $this->sendResponse(
            new VisiMisiResource($visi), 'VisiMisi retrieved successfully.');
    }
