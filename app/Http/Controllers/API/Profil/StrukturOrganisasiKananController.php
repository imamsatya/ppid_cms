...
use App\Http\Resources\StrukturOrganisasiKananResource;
...
class StrukturOrganisasiKananController extends BaseController
{
    /**
    ...
    {
        $struktur = StrukturOrganisasiBaganKanan::all();

        return $this->sendResponse(
            new StrukturOrganisasiKananResource($struktur->first()), 'StrukturOrganisasi retrieved successfully.');
    }
    /**
    ...
    {
        $struktur = StrukturOrganisasiBaganKanan::find($id);
        ...
        return $this->sendResponse(
            new StrukturOrganisasiKananResource($struktur), 'StrukturOrganisasi retrieved successfully.');
    }
