                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            @can('informasi serta merta.edit')
                                <!--begin::Edit button-->
                                <label
                        ...
                        <br> @can('informasi serta merta.create')
            ...
            <div class="card card-flush shadow-sm">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        @can('informasi serta merta.create')
                        ...
                        <tbody>
                            @if ($informasiSertaMerta)
                                @foreach ($informasiSertaMerta as $informasiSertaMerta_row)
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td>{{ $informasiSertaMerta_row->judul_informasi }}</td>
                                        ...
                                        @canany(['informasi serta merta.edit', 'informasi serta merta.delete'])
                                            <td>
                                                ...
                                                @endcan
                                                @can('informasi serta merta.delete')
            ...
            @push('child-scripts')
                <script>
                    ...
                    function deleteDialog(index) {
                        ...
                        let informasiSertaMerta = {{ Js::from($informasiSertaMerta) }}
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    type: "DELETE",
                                    url: "/manajemen-ppid/informasi_serta_merta/" + informasiSertaMerta.id,
                                    cache: false,
