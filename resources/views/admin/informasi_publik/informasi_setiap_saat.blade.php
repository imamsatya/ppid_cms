                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            @can('informasi setiap saat.edit')
                                <!--begin::Edit button-->
                                <label
                        ...
                        <br> @can('informasi setiap saat.create')
            ...
            <div class="card card-flush shadow-sm">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        @can('informasi setiap saat.create')
                        ...
                        <tbody>
                            @if ($informasiSetiapSaat)
                                @foreach ($informasiSetiapSaat as $informasiSetiapSaat_row)
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td>{{ $informasiSetiapSaat_row->judul_informasi }}</td>
                                        ...
                                        @canany(['informasi setiap saat.edit', 'informasi setiap saat.delete'])
                                            <td>
                                                ...
                                                @endcan
                                                @can('informasi setiap saat.delete')
            ...
            @push('child-scripts')
                <script>
                    ...
                    function deleteDialog(index) {
                        ...
                        let informasiSetiapSaat = {{ Js::from($informasiSetiapSaat) }}
