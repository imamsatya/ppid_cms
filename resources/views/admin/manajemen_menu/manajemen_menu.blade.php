                ...
                <div class="row row-cols-lg-1 g-10 min-h-200px draggable-zone">
                    ...
                    @if ($menus)
                        @foreach ($menus as $menu)
                            <div class="col draggable" namamenu="{{ $menu->nama_menu }}" idmenu="{{ $menu->id }}"
                                routing="{{ $menu->routing ?? '-' }}" permission="{{ $menu->nama_permission ?? '-' }}">
                                <!--begin::Card-->
                                <div class="card ">
                                    <div class="card-header">
                                        <div class="card-title">
                                            ...
                                            <span class="badge badge-primary me-2">{{ $menu->routing ?? '-' }}</span>
                                            <span class="badge badge-info ">{{ $menu->nama_permission ?? '-' }}</span>
                                            <br>
                                    ...
                                    <div class="card-body">
                                        {{-- <span class="badge badge-primary">{{ $menu->routing ?? '-' }}</span>
                                        <span class="badge badge-info">{{ $menu->nama_permission ?? '-' }}</span> --}}
                                        {{-- <div class="row mb-2">
                                            <!--begin::Label-->
                                            <label class="col-lg-1 ">Routing</label>
                                            <!--end::Label-->
                                            <!--begin::Col-->
                                            <div class="col-lg-8 ">
                                                : {{ $menu->routing ?? '-' }}
                                        ...
                                        <div class="row mb-2">
                                            <!--begin::Label-->
                                            <label class="col-lg-1 ">Permission</label>
                                            <!--end::Label-->
                                            <!--begin::Col-->
                                            <div class="col-lg-8 ">
                                                : {{ $menu->nama_permission ?? '-' }}
                                            </div>
                                            <!--end::Col-->
                                        </div> --}}
                                        {{-- <hr> --}}

                                        <div class="row row-cols-lg-1 g-10 min-h-20px  draggable2-zone">
                                            <br>
                                            @if ($menu->submenus)
                                                    ...
                                                    <tbody>
                                                        @foreach ($menu->submenus as $submenu)
                                                            <tr class="draggable2">
                                                                ...
                                                                <td>{{ $loop->index + 1 }}</td>
                                                                <td> {{ $submenu->nama_menu }}" />
                                                                </td>
                                                                <td>{{ $submenu->routing }}</td>
                                ...
                                <div class="row row-cols-1 g-10 min-h-200px draggable-zone">
                                    ...
                                    <div class="col draggable">
                                        ...
                                        <div class="card bg-light-success">
                                            ...
                                            an
                                            unknown printer took a galley of type and scrambled. Lorem Ipsum is simply
                                            dummy
            ...
            @push('child-scripts')
                ...
                <script>
                    ...
                    async function saveMenu() {
                        ...
                        console.log('mainMenu', mainMenu.length)
                        for (let index = 0; index < mainMenu.length; index++) {
                            let currentMenu = {
                                id_menu: mainMenu[index].attributes.idmenu,
                                nama_menu: mainMenu[index].attributes.namamenu,
                                routing: mainMenu[index].attributes.routing,
                                permission: mainMenu[index].attributes.permission,
                                urutan: index + 1
                            }
