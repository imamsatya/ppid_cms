...
<body data-kt-name="metronic" id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
                    ...
                    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                        ...
                        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3"
                                ...
                                <!--begin:Menu item-->
                                @canany(['data permohonan.view', 'data keberatan.view'])
                                    <div data-kt-menu-trigger="click"
                                        class="menu-item menu-accordion {{ $isShowAccordion_layananPPID ?? '' }}">
                                        <!--begin:Menu link-->
                                        <span class="menu-link {{ $isActiveLink_layananPPID ?? '' }}">
                                            <span class="menu-icon">
                                ...
                                @canany([
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            @can('tugas dan fungsi ppid.view')
                                                <!--begin:Menu item-->
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                ...
                                <!--begin:Menu Regulasi-->
                                @canany(['peraturan kip.view', 'rancangan peraturan kip.view'])
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        <!--begin:Menu link-->
                                        <span class="menu-link">
                                            <span class="menu-icon">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            @can('rancangan peraturan kip.view')
                                                <!--begin:Menu item-->
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link"
                                ...
                                @canany([
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <!--begin:Menu sub-->
                                        <div class="menu-sub menu-sub-accordion">
                                            @can('informasi secara berkala.view')
                                                <!--begin:Menu item-->
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link"
                                            ...
                                            @can('informasi serta merta.view')
                                                <!--begin:Menu item-->
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link"
                                            ...
                                            @can('informasi setiap saat.view')
                                                <!--begin:Menu item-->
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link"
                                ...
                                @canany([
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <!--begin:Menu sub-->
                                        <div class="menu-sub menu-sub-accordion">
                                            @can('laporan triwulanan pip.view')
                                                <!--begin:Menu item-->
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link"
                                ...
                                @canany(['maklumat pelayanan.view', 'prosedur pelayanan.view', 'biaya pelayana.view'])
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        <!--begin:Menu link-->
                                        <span class="menu-link">
                                            <span class="menu-icon">
                            ...
                            <div id="kt_app_toolbar_container"
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <li class="breadcrumb-item text-muted">{{ $mainMenuTitle ?? '' }}</li>
                                        <!--end::Item-->
    ...
    <script src="{{ asset('template/dist/assets/js/widgets.bundle.js') }}"></script>
    <script src="{{ asset('template/dist/assets/js/custom/widgets.js') }}"></script>
    <script src="{{ asset('template/dist/assets/js/custom/utilities/modals/upgrade-plan.js') }}"></script>
    <script src="{{ asset('template/dist/assets/js/custom/utilities/modals/create-app.js') }}"></script>
    <script src="{{ asset('template/dist/assets/js/custom/utilities/modals/new-target.js') }}"></script>
