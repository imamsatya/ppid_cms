...
<?php $component->withAttributes([]); ?>
    ...
    <div id="roleVue">
        ...
        <br>
        <?php if($role): ?>
            <h1>Edit Role Permission <?php echo e($role->name ?? ''); ?> </h1>
        <?php endif; ?>
        <br>
        <!--begin::Row-->
        ...
        <div class="card card-flush shadow-sm">
            ...
            <div class="card-body py-5">
                ...
                <div class="modal-body  mx-lg-5 my-0">
                    <!--begin::Form-->
                    <form id="editForm" class="form" action="<?php echo e(route('admin.role_permission.update', $role)); ?>"
                        method="POST">
                        <?php echo csrf_field(); ?>
                         ...
                         <?php $__env->slot('mainMenuTitle', null, []); ?> 
                            ...
                            <?php $__env->startPush('child-scripts'); ?>
                                <script>
                                    ...
                                    let role = <?php echo e(Js::from($role)); ?>
...
<?php endif; ?>
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/admin/manajemen_user/edit-role_permission.blade.php ENDPATH**/ ?>