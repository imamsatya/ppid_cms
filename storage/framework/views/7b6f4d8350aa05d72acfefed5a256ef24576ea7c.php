            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <?php if($visiMisi): ?>
                                <?php if($visiMisi->banner_path): ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                                        style="background-image: url(<?php echo e(asset('storage/'.$visiMisi->banner_path)); ?>)">
                                    </div>
                                <?php else: ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('visi dan misi.edit')): ?>
                                <!--begin::Edit button-->
                                <label
                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <?php if($visiMisi): ?>
                            <?php if(auth()->user()->can('visi dan misi.edit')): ?>
                ...
                <br>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('visi dan misi.create')): ?>
...
<?php endif; ?>
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/admin/profil/visimisi.blade.php ENDPATH**/ ?>