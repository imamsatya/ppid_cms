         ...
         <?php $__env->slot('mainMenuTitle', null, []); ?> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="statistik">
                        <br>
                        <h3 for="">Statistik Permohonan Informasi Publik Tahun <?php echo e(date('Y')); ?></h3>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\project0\laravelBase\resources\views/admin/dashboard/dashboard.blade.php ENDPATH**/ ?>