                        ...
                        <?php $__env->startPush('child-scripts'); ?>
                            <script>
                                ...
                                function editDialog(index) {
                                    ...
                                    let node;
                                    let textnode
                                    let permissions = <?php echo e(Js::from($permissions)); ?>
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><a href="javascript:void(0)" data-value="<?php echo e($loop->index); ?>"
                                                        ...
                                                        <a href="javascript:void(0)"
                                                            onclick="deleteDialog(<?php echo e($loop->index); ?>)"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body py-lg-10 px-lg-10">
                                            ...
                                            <form id="kt_account_profile_details_form" class="form"
                                                action="<?php echo e(route('admin.role_permission.store')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <!--begin::Card body-->
...
<?php endif; ?>
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/admin/manajemen_user/role_permission.blade.php ENDPATH**/ ?>