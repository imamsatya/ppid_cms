                    ...
                    <table id="kt_datatable_column_rendering" class="table table-striped table-row-bordered gy-5 gs-7">
                        <thead>
                            <tr class="fw-semibold fs-6 text-gray-800">
                                ...
                                <th>Deskripsi</th>
                                <th>Urutan</th>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['video.delete', 'video.edit'])): ?>
                                    <th>Aksi</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <?php $__currentLoopData = $video; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($video_row->url); ?></td>
                                    <td><?php echo e($video_row->deskripsi); ?></td>
                                    <td><?php echo e($video_row->urutan); ?></td>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['video.edit', 'video.delete'])): ?>
                                        <td>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('video.edit')): ?>
                                            ...
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('video.delete')): ?>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body py-lg-10 px-lg-10">
                            ...
                            <form id="kt_account_profile_details_form" enctype="multipart/form-data"
                                action="<?php echo e(route('admin.video.store')); ?>" method="POST" class="form">
                                <?php echo csrf_field(); ?>
                                <!--begin::Card body-->
                                ...
                                <?php $__env->startPush('child-scripts'); ?>
                                    <script>
                                        ...
                                        function deleteDialog(index) {
                                            ...
                                            let video = <?php echo e(Js::from($video)); ?>
                                        ...
                                        function editDialog(index) {
                                            ...
                                            let videoRow = <?php echo e(Js::from($video)); ?>
...
<?php endif; ?>
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/admin/manajemen_home/video.blade.php ENDPATH**/ ?>