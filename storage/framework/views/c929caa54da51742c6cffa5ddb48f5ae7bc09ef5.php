        ...
        Profil Singkat PPID
         ...
         <?php $__env->slot('mainMenuTitle', null, []); ?> 
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <?php if($profilSingkat): ?>
                                <?php if($profilSingkat->banner_path): ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                                        style="background-image: url(<?php echo e(asset('storage/'.$profilSingkat->banner_path)); ?>)">
                                    </div>
                                <?php else: ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                    ...
                    <div class="card-body py-5">
                            ...
                            <?php if($profilSingkat): ?>
                                <?php if(auth()->user()->can('profil singkat ppid.edit')): ?>
                                    <input type="text" name="judul" class="form-control form-control-solid"
                                        placeholder="Judul Profil Singkat PPID" value="<?php echo e($profilSingkat->judul); ?>" />
                                <?php else: ?>
                        ...
                        <?php if($profilSingkat): ?>
                            <?php if(auth()->user()->can('profil singkat ppid.edit')): ?>
                                ...
                                <?php echo e($profilSingkat->konten); ?>
                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <!--begin::Image preview wrapper-->
                            <?php if($profilSingkat): ?>
                                <?php if($profilSingkat->side_image_path): ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                                        style="background-image: url(<?php echo e(asset('storage/'.$profilSingkat->side_image_path)); ?>)">
                                    </div>
                                <?php else: ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                                        style="background-image: url(<?php echo e(asset('template/dist/assets/media/patterns/pattern-1.jpg')); ?>)">
                ...
                <br>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('profil singkat ppid.create')): ?>
...
<?php endif; ?>
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/admin/profil/profilsingkat.blade.php ENDPATH**/ ?>