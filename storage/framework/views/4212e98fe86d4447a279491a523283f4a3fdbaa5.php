                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('laporan hasil survei.edit')): ?>
                                <!--begin::Edit button-->
                                <label
                        ...
                        <br> <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('laporan hasil survei.create')): ?>
            ...
            <div class="card card-flush shadow-sm">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('laporan hasil survei.create')): ?>
                            ...
                            <?php if($laporanHasilSurvei): ?>
                                <?php $__currentLoopData = $laporanHasilSurvei; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laporanHasilSurvei_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($laporanHasilSurvei_row->judul_laporan); ?></td>
                                        <td><a
                                                href="<?php echo e(asset('storage/' . $laporanHasilSurvei_row->file_path)); ?>"><?php echo e($laporanHasilSurvei_row->judul_laporan . '.pdf'); ?></a>
                                        </td>
                                        <td><img width="100" height="100"
                                                src="<?php echo e(asset('storage/' . $laporanHasilSurvei_row->thumbnail_path)); ?>" />
                                        </td>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['laporan hasil survei.edit', 'laporan hasil survei.delete'])): ?>
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('laporan hasil survei.edit')): ?>
                                                ...
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('laporan hasil survei.delete')): ?>
            ...
            <?php $__env->startPush('child-scripts'); ?>
                <script>
                    ...
                    function deleteDialog(index) {
                        ...
                        let laporanHasilSurvei = <?php echo e(Js::from($laporanHasilSurvei)); ?>
                    ...
                    function editDialog(index) {
                        ...
                        document.getElementById('editLaporanImage').style.cssText =
                            `background-image: url(<?php echo e(asset('storage/${laporanHasilSurvei.thumbnail_path}')); ?>)`
...
<?php endif; ?>
<?php /**PATH /Data/ppiddev2022/resources/views/admin/laporan/laporan_hasil_survei.blade.php ENDPATH**/ ?>