...
<body class="<?php echo e(Route::current()->getName() == 'index' ? 'zoomed' : ''); ?> magnify" id="bwStyle">

    <!-- navbar -->
    <section>
        <header id="headerNav">
            <a href="<?php echo e(route('index')); ?>" class="logo">
                <img src="<?php echo e(asset('ppid_fe/assets/images/content//logo/logo_ppid.png')); ?>" alt="" />
            </a>
            ...
            <nav class="navbar_custom">
                <ul>
                    <li>
                        <a href="#" id="titleNavProfile" class="<?php echo e($isActiveProfil ?? ''); ?>">Profil </a>
                        <ul>
                            <li>
                                <a class="dropdown_menu" href="<?php echo e(route('tentangppid.index')); ?>">Tentang PPID</a>
                            </li>

                            <li>
                                <a class="dropdown_menu" href="<?php echo e(route('tugasdanfungsi.index')); ?>">Tugas dan Fungsi</a>
                            </li>
                            <li>
                                <a class="dropdown_menu" href="<?php echo e(route('strukturppid.index')); ?>">Struktur PPID</a>
                            </li>
                            <li>
                                <a class="dropdown_menu" href="<?php echo e(route('visimisi.index')); ?>">Visi dan Misi</a>
                            </li>
                            <li>
                                <a class="dropdown_menu" href="<?php echo e(route('kontak.index')); ?>">Kontak</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="<?php echo e(route('regulasi.index')); ?>" class="<?php echo e($isActiveRegulasi ?? ''); ?>"
                            id="titleNavRegulasi">Regulasi </a>
                    </li>
                    <li>
                        <a id="titleNavInformasiPublik" class="<?php echo e($isActiveInformasiPublik ?? ''); ?>"
                            href="<?php echo e(route('informasipublik.index')); ?>">Informasi
                            Publik</a>
                    </li>
                    <li>
                        <a id="titleNavStandarLayanan" class="<?php echo e($isActiveStandarLayanan ?? ''); ?>"
                            href="#">Standar Layanan </a>
                        <ul>
                            <li>
                                <a class="dropdown_menu" href="<?php echo e(route('maklumat.index')); ?>">Maklumat</a>
                            </li>

                            <li>
                                <a class="dropdown_menu" href="<?php echo e(route('prosedurlayanan.index')); ?>">Prosedur
                                    Layanan</a>
                            </li>
                            <li>
                                <a class="dropdown_menu" href="<?php echo e(route('standarlayananbiaya.index')); ?>">Biaya
                                    Layanan</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a id="titleNavLaporan" class="<?php echo e($isActiveLaporan ?? ''); ?>"
                            href="<?php echo e(route('laporan.index')); ?>">Laporan </a>
                    </li>
                    <li>
                        <a id="titleNavFaq" class="<?php echo e($isActiveFaq ?? ''); ?>" href="<?php echo e(route('faq.index')); ?>">FAQ</a>
                    </li>
                    <?php if(Route::current()->getName() != 'dashboard.index'): ?>
                        <li>
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-sm btn_login"> Login
                            </a>
...
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/components/frontend/layoutb.blade.php ENDPATH**/ ?>