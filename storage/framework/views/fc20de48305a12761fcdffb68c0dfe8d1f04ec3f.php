            ...
            <?php $__env->startPush('child-scripts'); ?>
                ...
                <script>
                    ...
                    function deleteDialog(index) {
                        let dokumentasi = <?php echo e(Js::from($dokumentasi)); ?>
                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <?php if($kontak): ?>
                                <?php if($kontak->banner_path): ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                                        style="background-image: url(<?php echo e(asset('storage/' . $kontak->banner_path)); ?>)">
                                    </div>
                                <?php else: ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('kontak.edit')): ?>
                                <!--begin::Edit button-->
                                <label
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <?php if($kontak): ?>
                                        <?php if(auth()->user()->can('kontak.edit')): ?>
                                            <input type="text" name="alamat"
                                                class="form-control form-control-lg form-control-solid"
                                                placeholder="Alamat Kantor Kementrian BUMN"
                                                value="<?php echo e($kontak->alamat); ?>" />
                                        <?php else: ?>
                                    ...
                                    <?php if($kontak): ?>
                                        <?php if(auth()->user()->can('kontak.edit')): ?>
                                            <input type="text" name="telepon"
                                                ...
                                                value="<?php echo e($kontak->telepon); ?>" />
                                        <?php else: ?>
                                    ...
                                    <?php if($kontak): ?>
                                        <?php if(auth()->user()->can('kontak.edit')): ?>
                                            <input type="email" name="email"
                                                class="form-control form-control-lg form-control-solid"
                                                placeholder="email resmi PPID KBUMN" value="<?php echo e($kontak->email); ?>" />
                                        <?php else: ?>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <?php if($kontak): ?>
                                        ...
                                        <?php echo e($kontak->waktu_pelayanan); ?>
                                    ...
                                    <?php if($kontak): ?>
                                        <?php if(auth()->user()->can('kontak.edit')): ?>
                                            <input type="text" name="latitude"
                                                class="form-control form-control-lg form-control-solid"
                                                placeholder="Latitude" value="<?php echo e($kontak->latitude); ?>" />
                                        <?php else: ?>
                                    ...
                                    <?php if($kontak): ?>
                                        <?php if(auth()->user()->can('kontak.edit')): ?>
                                            <input type="text" name="longitude"
                                                class="form-control form-control-lg form-control-solid"
                                                placeholder="Longitude" value="<?php echo e($kontak->longitude); ?>" />
                                        <?php else: ?>
                        ...
                        <div class="card-footer d-flex justify-content-start py-6 px-9">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('kontak.create')): ?>
                    ...
                    <table id="kt_datatable_column_rendering"
                        ...
                        <thead>
                            <tr class="fw-semibold fs-6 text-gray-800">
                                ...
                                <th>Keterangan</th>
                                <th>Urutan</th>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('kontak.delete')): ?>
                                    <th>Aksi</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $__currentLoopData = $dokumentasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dokumentasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($loop->index + 1); ?></td>
                                    <td> <img width="100" height="100"
                                            src="<?php echo e(asset('storage/' . $dokumentasi->image_path)); ?>" />
                                    </td>
                                    <td><?php echo e($dokumentasi->keterangan); ?></td>
                                    <td><?php echo e($dokumentasi->urutan); ?></td>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('kontak.delete')): ?>
                                        <td><a href="javascript:void(0)" onclick="deleteDialog(<?php echo e($loop->index); ?>)"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body py-lg-10 px-lg-10">
                            ...
                            <form id="kt_account_profile_details_form" enctype="multipart/form-data"
                                action="<?php echo e(route('admin.kontak.dokumentasi.store')); ?>" method="POST"
                                class="form">
                                <?php echo csrf_field(); ?>
                                <!--begin::Card body-->
...
<?php endif; ?>
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/admin/profil/kontak.blade.php ENDPATH**/ ?>