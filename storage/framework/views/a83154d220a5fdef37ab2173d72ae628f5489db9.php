     ...
     <?php $__env->slot('subMenuTitle', null, []); ?> 
        Biaya Layanan
         ...
         <?php $__env->slot('mainMenuTitle', null, []); ?> 
            ...
            <form action="<?php echo e(route('admin.biayalayanan.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <?php if($biayaLayanan): ?>
                                <?php if($biayaLayanan->banner_path): ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                                        style="background-image: url(<?php echo e(asset('storage/' . $biayaLayanan->banner_path)); ?>)">
                                    </div>
                                <?php else: ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('biaya pelayanan.edit')): ?>
                                <!--begin::Edit button-->
                                <label
                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="mb-10">
                            ...
                            <?php if($biayaLayanan): ?>
                                <?php if(auth()->user()->can('profil singkat ppid.edit')): ?>
                                    <textarea name="deskripsi" id="kt_docs_ckeditor_classic_konten">
                                <?php echo e($biayaLayanan->deskripsi); ?>
                        ...
                        <div class="mb-10">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                ...
                                <!--begin::Image preview wrapper-->
                                <?php if($biayaLayanan): ?>
                                    <?php if($biayaLayanan->direktori_image): ?>
                                        <div class="image-input-wrapper w-500px  h-350px"
                                            style="background-image: url(<?php echo e(asset('storage/' . $biayaLayanan->direktori_image)); ?>)">
                                        </div>
                                    <?php else: ?>
                                        <div class="image-input-wrapper w-500px  h-350px"
                                            style="background-image: url(<?php echo e(asset('template/dist/assets/media/patterns/pattern-1.jpg')); ?>)">
                            ...
                            <br>
                            <br> <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('biaya pelayanan.create')): ?>
...
<?php endif; ?>
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/admin/standar_layanan/biaya_layanan.blade.php ENDPATH**/ ?>