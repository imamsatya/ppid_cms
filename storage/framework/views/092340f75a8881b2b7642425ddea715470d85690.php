        ...
        <div class="card card-flush shadow-sm">
            ...
            <div class="card-body py-5">
                ...
                <div class="modal-body  mx-lg-5 my-0">
                    <!--begin::Form-->
                    <form id="kt_modal_add_role_form" action="<?php echo e(route('admin.role_permission.store')); ?>" class="form"
                        method="POST">
                        <?php echo csrf_field(); ?>
                        <!--begin::Scroll-->
...
<?php endif; ?>
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/admin/manajemen_user/add-role_permission.blade.php ENDPATH**/ ?>