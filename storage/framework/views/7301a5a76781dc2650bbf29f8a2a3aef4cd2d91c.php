            ...
            <form action="<?php echo e(route('admin.informasi_secara_berkala.banner.store')); ?>" method="POST"
                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <br> <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('informasi secara berkala.create')): ?>
                            ...
                            <?php if($informasiSecaraBerkala): ?>
                                <?php $__currentLoopData = $informasiSecaraBerkala; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $informasiSecaraBerkala_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($informasiSecaraBerkala_row->judul_informasi); ?></td>
                                        <td><?php echo e($informasiSecaraBerkala_row->url); ?></td>
                                        <td>
                                            <?php if($informasiSecaraBerkala_row->file_path): ?>
                                                <a
                                                    href="<?php echo e(asset('storage/' . $informasiSecaraBerkala_row->file_path)); ?>">file</a>
                                            <?php endif; ?>
                                        </td>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['informasi secara berkala.edit', 'informasi secara berkala.delete'])): ?>
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('informasi secara berkala.edit')): ?>
                                                ...
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('informasi secara berkala.delete')): ?>
            ...
            <?php $__env->startPush('child-scripts'); ?>
                <script>
                    ...
                    function deleteDialog(index) {
                        ...
                        let informasiSecaraBerkala = <?php echo e(Js::from($informasiSecaraBerkala)); ?>
...
<?php endif; ?>
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/admin/informasi_publik/informasi_secara_berkala.blade.php ENDPATH**/ ?>