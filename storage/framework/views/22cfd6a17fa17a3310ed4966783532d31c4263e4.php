     ...
     <?php $__env->slot('subMenuTitle', null, []); ?> 
        Laporan Triwulanan PIP
         ...
         <?php $__env->slot('mainMenuTitle', null, []); ?> 
                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('laporan triwulanan pip.edit')): ?>
                                <!--begin::Edit button-->
                                <label
                        ...
                        <br> <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('laporan triwulanan pip.create')): ?>
            ...
            <br>
            <h1>Pengelolaan Laporan Triwulanan PIP</h1>
            <br>
            <div class="card card-flush shadow-sm">
                <div class="card-header">
                    <h3 class="card-title">Laporan Triwulanan PIP</h3>
                    <div class="card-toolbar">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('laporan triwulanan pip.create')): ?>
                            ...
                            <?php if($laporanTriwulanan): ?>
                                <?php $__currentLoopData = $laporanTriwulanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laporanTriwulanan_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($laporanTriwulanan_row->judul_laporan); ?></td>
                                        <td><a
                                                href="<?php echo e(asset('storage/' . $laporanTriwulanan_row->file_path)); ?>"><?php echo e($laporanTriwulanan_row->judul_laporan . '.pdf'); ?></a>
                                        </td>
                                        <td><img width="100" height="100"
                                                src="<?php echo e(asset('storage/' . $laporanTriwulanan_row->thumbnail_path)); ?>" />
                                        </td>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['laporan triwulanan pip.edit', 'laporan triwulanan pip.delete'])): ?>
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('laporan triwulanan pip.edit')): ?>
                                                ...
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('laporan triwulanan pip.delete')): ?>
                ...
                <div class="modal-dialog modal-dialog-centered mw-900px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <!--begin::Modal title-->
                            <h2>Tambah Laporan Triwulanan PIP</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
            ...
            <?php $__env->startPush('child-scripts'); ?>
                <script>
                    ...
                    function deleteDialog(index) {
                        ...
                        let laporanTriwulanan = <?php echo e(Js::from($laporanTriwulanan)); ?>


                        laporanTriwulanan = laporanTriwulanan[index]

                        Swal.fire({
                            html: `Apakah yakin akan <strong>menghapus</strong> Laporan Triwulanan PIP <span class="badge badge-primary"> ${laporanTriwulanan.judul_laporan}</span> ?`,
                            icon: "error",
                                ...
                                $.ajax({
                                    ...
                                    success: function(html) {
                                        Swal.fire({
                                            ...
                                            icon: 'success',
                                            title: 'Berhasil menghapus laporan triwulanan pip',
                    ...
                    function editDialog(index) {
                        ...
                        document.getElementById('editLaporanImage').style.cssText =
                            `background-image: url(<?php echo e(asset('storage/${laporanTriwulanan.thumbnail_path}')); ?>)`
...
<?php endif; ?>
<?php /**PATH /var/www/ppid_cms/resources/views/admin/laporan/laporan_triwulanan_pip.blade.php ENDPATH**/ ?>