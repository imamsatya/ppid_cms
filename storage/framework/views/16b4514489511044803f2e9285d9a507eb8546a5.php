    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <style>
            ...
            [data-theme="dark"] body {
                background-image: url('template/dist/assets/media/auth/bg10-dark.jpeg');
            }
        </style>
        <!--end::Page bg image-->
            ...
            <div class="d-flex flex-lg-row-fluid">
                ...
                <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                    ...
                    <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                        src="<?php echo e(asset('template/dist/assets/media/auth/agency.png')); ?>" alt="" />
                    <img class="theme-dark-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                        src="<?php echo e(asset('template/dist/assets/media/auth/agency-dark.png')); ?>" alt="" />
                    <!--end::Image-->
                    <!--begin::Title-->
            ...
            <div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12">
                ...
                <div class="bg-body d-flex flex-center rounded-4 w-md-600px p-10">
                    ...
                    <div class="w-md-400px">
                        ...
                        <?php endif; ?>
                        <!--begin::Form-->
                        <form class="form w-100" action="<?php echo e(route('admin.handleLogin')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <!--begin::Heading-->
                            ...
                            <div class="row g-3 mb-9">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="#"
                                        ...
                                        <img alt="Logo"
                                            src="<?php echo e(asset('template/dist/assets/media/svg/brand-logos/google-icon.svg')); ?>"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="#"
                                        class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                                        <img alt="Logo"
                                            src="<?php echo e(asset('template/dist/assets/media/svg/brand-logos/apple-black.svg')); ?>"
                                            class="theme-light-show h-15px me-3" />
                                        <img alt="Logo"
                                            src="<?php echo e(asset('template/dist/assets/media/svg/brand-logos/apple-black-dark.svg')); ?>"
...
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/auth/admin-login2.blade.php ENDPATH**/ ?>