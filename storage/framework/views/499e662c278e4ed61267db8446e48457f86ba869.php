            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(count(app('request')->all()) < 1 ? 'active' : null); ?> <?php echo e(app('request')->input('laporan_triwulanan') ? 'active' : null); ?>"
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(app('request')->input('laporan_tahunan') ? 'active' : null); ?>"
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(app('request')->input('laporan_hasil_survei') ? 'active' : null); ?>"
                    ...
                    <div class="tab-content mt-4" id="pills-tabContent">
                        <div class="tab-pane fade <?php echo e(count(app('request')->all()) < 1 ? 'show active' : null); ?> <?php echo e(app('request')->input('laporan_triwulanan') ? 'show active' : null); ?>"
                        ...
                        <div class="tab-pane fade <?php echo e(app('request')->input('laporan_tahunan') ? 'show active' : null); ?>"
                        ...
                        <div class="tab-pane fade <?php echo e(app('request')->input('laporan_hasil_survei') ? 'show active' : null); ?>"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\project0\laravelBase\resources\views/frontend/laporan/laporan.blade.php ENDPATH**/ ?>