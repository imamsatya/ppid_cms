                     ...
                     <?php $__env->slot('mainMenuTitle', null, []); ?> 
                        ...
                        <?php endif; ?>
                            <div class="card card-flush shadow-sm">
                                <form action="<?php echo e(route('admin.linksurvei.store')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="card-body py-5">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <?php if($linkSurvei): ?>
                                                <?php if(auth()->user()->can('data permohonan.edit')): ?>
                                                    <input type="text" name="linkSurvei" class="form-control form-control-solid"
                                                        placeholder="Link Survei" value="<?php echo e($linkSurvei->link); ?>" />
                                                <?php else: ?>
                                ...
                                <table id="kt_datatable_dom_positioning_daftarKeberatanMasuk"
                                    ...
                                    <thead>
                                        <tr class="fw-semibold fs-6 text-gray-800">
                                            ...
                                            <th>Batas Waktu</th>
                                            <th>Status</th>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('data keberatan.create')): ?>
                                                <th>Aksi</th>
                                            <?php endif; ?>
                                        </tr>
                                    </thead>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\project0\laravelBase\resources\views/admin/layanan_ppid/data_keberatan.blade.php ENDPATH**/ ?>