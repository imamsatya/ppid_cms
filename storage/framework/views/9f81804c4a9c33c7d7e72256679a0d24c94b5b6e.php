     ...
     <?php $__env->slot('subMenuTitle', null, []); ?> 
        Maklumat
         ...
         <?php $__env->slot('mainMenuTitle', null, []); ?> 
            ...
            <br>
            <h1>Pengelolaan Maklumat</h1>
            <br>


            <form action="<?php echo e(route('admin.maklumat.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <?php if($maklumat): ?>
                                <?php if($maklumat->banner_path): ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                                        style="background-image: url(<?php echo e(asset('storage/' . $maklumat->banner_path)); ?>)">
                                    </div>
                                <?php else: ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('maklumat pelayanan.edit')): ?>
                                <!--begin::Edit button-->
                                <label
                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="mb-10">
                            <label for="" class="required form-label">Maklumat Image</label>
                            <br>
                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                style="background-image: url(<?php echo e(asset('template/dist/assets/media/svg/avatars/blank.svg')); ?>)">
                                <!--begin::Image preview wrapper-->
                                <?php if($maklumat): ?>
                                    <?php if($maklumat->direktori_image): ?>
                                        <div class="image-input-wrapper w-500px  h-350px"
                                            style="background-image: url(<?php echo e(asset('storage/' . $maklumat->direktori_image)); ?>)">
                                        </div>
                                    <?php else: ?>
                                        <div class="image-input-wrapper w-500px  h-350px"
                                            style="background-image: url(<?php echo e(asset('template/dist/assets/media/patterns/pattern-1.jpg')); ?>)">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('maklumat pelayanan.edit')): ?>
                                    ...
                                    <label
                                        ...
                                        <!--begin::Inputs-->
                                        <input type="file" name="maklumat" accept=".png, .jpg, .jpeg" />
                                        <input type="hidden" name="maklumat_remove" />
                                        <!--end::Inputs-->
                                    </label>
                                    <!--end::Edit button-->
                            ...
                            <br>
                            <br> <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('maklumat pelayanan.create')): ?>
...
<?php endif; ?>
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/admin/standar_layanan/maklumat_layanan.blade.php ENDPATH**/ ?>