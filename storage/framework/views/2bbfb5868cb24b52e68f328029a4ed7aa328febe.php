            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-login">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('userppid.handleLogin')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="form-data">
...
<?php endif; ?>
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/auth/login.blade.php ENDPATH**/ ?>