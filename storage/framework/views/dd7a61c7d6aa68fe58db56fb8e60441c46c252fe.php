            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(count(app('request')->all()) < 1 ? 'active' : null); ?> <?php echo e(app('request')->input('peraturan_kip') ? 'active' : null); ?>"
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(app('request')->input('rancangan_peraturan_kip') ? 'active' : null); ?>"
                    ...
                    <div class="tab-content mt-4" id="pills-tabContent">
                        <div class="tab-pane fade <?php echo e(app('request')->input('peraturan_kip') ? 'show active' : null); ?> <?php echo e(count(app('request')->all()) < 1 ? 'show active' : null); ?>""
                        ...
                        <div class="tab-pane fade <?php echo e(app('request')->input('rancangan_peraturan_kip') ? 'show active' : null); ?>"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\project0\laravelBase\resources\views/frontend/regulasi/regulasi.blade.php ENDPATH**/ ?>