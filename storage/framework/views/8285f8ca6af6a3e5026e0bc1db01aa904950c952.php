    ...
    <section>
        <header id="headerNav" class="blackw ">
            ...
            <a href="<?php echo e(route('index')); ?>" class="logo">
                <img src="<?php echo e(asset('ppid_fe/assets/images/content//logo/logo_ppid2.png')); ?>" width="110"
                    alt="" />
            </a>
            <a href="https://bumn.go.id/" class="logo custom-logo">
                <img src="<?php echo e(asset('ppid_fe/assets/images/content//logo/logo_bumn.png')); ?>" width="110"
                    alt="" />
            </a>
                                    ...
                                    <li>
                                        <?php $__currentLoopData = $sosialMedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sosialMedia_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e($sosialMedia_row->url); ?>" target="_blank">
                                                <img class="img-fluid" src="<?php echo e('storage/' . $sosialMedia_row->icon); ?>"
...
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/components/frontend/layout.blade.php ENDPATH**/ ?>