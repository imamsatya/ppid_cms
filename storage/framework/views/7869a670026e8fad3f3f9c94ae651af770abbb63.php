        ...
        Tugas dan Fungsi
         ...
         <?php $__env->slot('mainMenuTitle', null, []); ?> 
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <?php if($tugasDanFungsi): ?>
                                <?php if($tugasDanFungsi->banner_path): ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                                        style="background-image: url(<?php echo e(asset('storage/' . $tugasDanFungsi->banner_path)); ?>)">
                                    </div>
                                <?php else: ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                    ...
                    <div class="card-body py-5">
                        ...
                        <?php if($tugasDanFungsi): ?>
                            <?php if(auth()->user()->can('tugas dan fungsi ppid.edit')): ?>
                                ...
                                <?php echo e($tugasDanFungsi->konten); ?>
                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <!--begin::Image preview wrapper-->
                            <?php if($tugasDanFungsi): ?>
                                <?php if($tugasDanFungsi->side_image_path): ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                                        style="background-image: url(<?php echo e(asset('storage/' . $tugasDanFungsi->side_image_path)); ?>)">
                                    </div>
                                <?php else: ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                                        style="background-image: url(<?php echo e(asset('template/dist/assets/media/patterns/pattern-1.jpg')); ?>)">
                            ...
                            <?php endif; ?>
                            <!--end::Image preview wrapper-->
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tugas dan fungsi ppid.edit')): ?>
                                <!--begin::Edit button-->
                                <label
                                    class="btn btn-icon btn-circle btn-color-muted btn-active-color-primary w-25px h-25px bg-body shadow"
                                    data-kt-image-input-action="change" data-bs-toggle="tooltip" data-bs-dismiss="click"
                ...
                <br>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tugas dan fungsi ppid.create')): ?>
...
<?php endif; ?>
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/admin/profil/tugasdanfungsi.blade.php ENDPATH**/ ?>