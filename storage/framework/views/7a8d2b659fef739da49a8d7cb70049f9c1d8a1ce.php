        ...
        Struktur Organisasi
         ...
         <?php $__env->slot('mainMenuTitle', null, []); ?> 
                ...
                <div class="card card-flush shadow-sm">
                    ...
                    <div class="card-body py-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <?php if($strukturOrganisasi): ?>
                                <?php if($strukturOrganisasi->banner_path): ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                                        style="background-image: url(<?php echo e(asset('storage/' . $strukturOrganisasi->banner_path)); ?>)">
                                    </div>
                                <?php else: ?>
                                    <div class="image-input-wrapper w-250px  h-125px"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('struktur organisasi.edit')): ?>
                                <!--begin::Edit button-->
                                <label
                        ...
                        <div class="mb-10 col-lg-6">
                            ...
                            <div id="nomenklaturRepeater">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="d-flex mb-4" data-repeater-item>
                                                                <input type="text"
                                                                    ...
                                                                    value="<?php echo e($baganKiri_row->nomenklatur); ?>"
                                                                    name="nomenklatur" />
                                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('struktur organisasi.edit')): ?>
                                ...
                                <div class="form-group mt-5">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('struktur organisasi.create')): ?>
                    ...
                    <table id="kt_datatable_dom_positioning_baganKanan"
                        ...
                        <thead>
                            <tr class="fw-semibold fs-6 text-gray-800">
                                ...
                                <th>Urutan</th>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['struktur organisasi.edit', 'struktur organisasi.delete'])): ?>
                                    <th>Aksi</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                            ...
                            <?php if($baganKanan): ?>
                                <?php $__currentLoopData = $baganKanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $baganKanan_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($baganKanan_row->nomenklatur); ?></td>
                                        <td><?php echo e($baganKanan_row->deskripsi); ?></td>
                                        <td><?php echo e($baganKanan_row->urutan); ?></td>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['struktur organisasi.edit', 'struktur organisasi.delete'])): ?>
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('struktur organisasi.edit')): ?>
                                                ...
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('struktur organisasi.delete')): ?>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body py-lg-10 px-lg-10">
                            ...
                            <form id="kt_account_profile_details_form"
                                action="<?php echo e(route('admin.strukturorganisasi.bagankanan.store')); ?>" method="POST"
                                class="form">
                                <?php echo csrf_field(); ?>
                                <!--begin::Card body-->
            ...
            <?php $__env->startPush('child-scripts'); ?>
                <script src="<?php echo e(asset('template/dist/assets/plugins/custom/formrepeater/formrepeater.bundle.js')); ?>"></script>
                ...
                <script>
                    ...
                    function deleteDialog(index) {
                        console.log(index)
                        let baganKanan = <?php echo e(Js::from($baganKanan)); ?>
...
<?php endif; ?>
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/admin/profil/strukturorganisasi.blade.php ENDPATH**/ ?>