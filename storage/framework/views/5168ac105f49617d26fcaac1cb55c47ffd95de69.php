        ...
        Setting Kalender
         ...
         <?php $__env->slot('mainMenuTitle', null, []); ?> 
            ...
            <div class="card card-flush shadow-sm">
                ...
                <div class="card-body py-5">
                    ...
                    <table id="kt_datatable_dom_positioning_kalender"
                        ...
                        <tbody>
                            <?php if($kalenderLibur): ?>
                                <?php $__currentLoopData = $kalenderLibur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kalenderLibur_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($loop->index + 1); ?></td>
                                        <td><?php echo e($kalenderLibur_row['tanggal']); ?></td>
                                        <td><?php echo e($kalenderLibur_row['hari']); ?></td>
                                        <td><?php echo e($kalenderLibur_row['keterangan']); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
            ...
            <?php $__env->startPush('child-scripts'); ?>
                ...
                <script src="<?php echo e(asset('template/dist/assets/js/custom/apps/calendar/calendar.js')); ?>"></script>
                <script>
...
<?php endif; ?>
<?php /**PATH /Users/anggadwiarifandi/Documents/projects.nosync/ppid_cms/resources/views/admin/referensi/setting_kalender.blade.php ENDPATH**/ ?>